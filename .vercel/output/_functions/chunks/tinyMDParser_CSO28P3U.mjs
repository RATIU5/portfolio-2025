import { c as combineHtmlExtensions, p as push, n as normalizeIdentifier, d as decodeNumericCharacterReference, a as decodeNamedCharacterReference, b as postprocess, e as parse, f as preprocess } from './preprocess_RaMgX3TQ.mjs';
import { e as encode, s as sanitizeUri, g as gfmHtml, a as gfm } from './index_DcOdXHK4.mjs';
...
const parseMarkdown = (str) => micromark(str, {
  extensions: [gfm()],
