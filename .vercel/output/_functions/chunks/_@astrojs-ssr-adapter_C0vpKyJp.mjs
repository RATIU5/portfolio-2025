...
import { ah as ROUTE_TYPE_HEADER, X as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, A as AstroError, ac as ActionNotFoundError, al as s, ap as clientAddressSymbol, ay as LocalsNotAnObject, az as FailedToFindPageMapSSR, aA as REROUTABLE_STATUS_CODES, at as responseSentSymbol, aB as nodeRequestAbortControllerCleanupSymbol, aC as getAugmentedNamespace, aD as commonjsGlobal } from './astro/server_D64VbtqW.mjs';
import { D as DEFAULT_404_ROUTE, e as default404Instance, f as ensure404Route } from './astro-designed-error-pages_BH2yPH3_.mjs';
...
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_CPzUL-pe.mjs';
import { a as setGetEnv } from './runtime_BZzZctv8.mjs';
...
function apply() {
  if (!globalThis.crypto) {
    Object.defineProperty(globalThis, "crypto", {
      value: crypto__default.webcrypto
    });
  }
  if (!globalThis.File) {
    Object.defineProperty(globalThis, "File", {
      value: require$$0.File
    });
  }
}
...
function requireDist () {
	...
	const node_crypto_1 = crypto__default;
